...
export default function AIChatWindow({
    ...
    const sendMessage = async () => {
        ...
        // Ensure the user's message stays in the chat
        ...
        const payload = {
            ...
            conversation_history: messages,  // Send full history
        };
        ...
        try {
            ...
            // Append an empty AI message first, so it remains visible
            ...
            while (true) {
                ...
                console.log("🤖 AI RESPONSE (Streaming):", aiResponse);
            }
    
            // 🔹 After AI message is fully processed, log the entire conversation
            ...
            setMessages((prev) => [
                ...prev,
                { role: 'ai', content: '⚠️ Error: Failed to fetch response.', timestamp: new Date().toLocaleTimeString() },
            ]);
        } finally {
            setLoading(false);
        }
